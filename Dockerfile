...
COPY . /go/src/github.com/webtor-io/content-prober

# set workdir
WORKDIR /go/src/github.com/webtor-io/content-prober/server
...
COPY --from=build /go/src/github.com/webtor-io/content-prober/server/server .
